module github.com/tfmcdigital/aws-service-proxy

go 1.18

require github.com/elliotchance/sshtunnel v1.3.1
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ecs v1.18.13 // indirect
